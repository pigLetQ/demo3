...
declare const useLayoutEffect: (callback: (mount: boolean) => void, deps?: React.DependencyList) => void;
export declare const useComponentUpdateEffect: typeof React.useEffect;
