...
export interface AlipayMarketingActivityDeliveryCreateOptions extends BaseOpenapiOptions {
    bizContent: {
...
export interface AlipayMarketingActivityDeliveryCreateResult extends BaseOpenapiResult {
    delivery_guide_preview_url?: string;
    delivery_id: string;
...
export interface AlipayMarketingActivityDeliveryCreate {
    request(options: AlipayMarketingActivityDeliveryCreateOptions): Promise<AlipayMarketingActivityDeliveryCreateResult>;
}
